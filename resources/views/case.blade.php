...
<body>
    ...
    <!--Responsive Nav-->
<!--Start Attornets -->
<div class="attorney_detail seaction_margin">
    <div class="container">
        <div class="row">
            <div class="col-lg-5 col-md-12">
                <figure>
                    <img src="{{asset('uploads/image/'.$crime->image)}}" alt="">
                </figure>
            </div>
            <div class="col-lg-7 col-md-12 content">
                <div class="row">
                    <div class="col-md-7 col-sm-7 mb-2">
                        <h1>{{$crime->name}}</h1>
                        <cite>{{$crime->casecategory}}</cite>
                    </div>

                </div>
                <div class="meta">
                    <ul>
                        <li><i class="fa fa-file"></i> {{$crime->case_id}}</li>
                    </ul>
                </div>
                <h5>{{$crime->title}}</h5>
                {!!$crime->description!!}
