      ...
      <div class="col-lg-12">
        ...
        <div class="card">
          <div class="card-body">
            ...
            <form class="insform" action="{{url('/admin/case/update/'.$crime->id)}}" method="post" enctype="multipart/form-data">
                @csrf
            <!-- Quill Editor Full -->
            <div class="row">
                <div class="col-6">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" name="name" value="{{$crime->name}}" class="form-control">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group mb-3">
                        <label for="Case Description"> Case ID</label>
                        <input type="text" name="case_id" value="{{$crime->case_id}}" class="form-control">
                    </div>
                </div>
                <div class="col-12">
                    <div class="form-group mb-3">
                        <label for="Case Description"> Case Title</label>
                        <input type="text" name="title" value="{{$crime->title}}" class="form-control">
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group mb-3">
